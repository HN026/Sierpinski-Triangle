...
def main(width, height):
    ...
    images = []
    filenames = sorted((fn for fn in os.listdir('./out') if fn.endswith('.jpg')), key=lambda fn: os.path.getmtime('./out/' + fn))

    for filename in filenames:
        images.append(imageio.imread('./out/' + filename))
    imageio.mimsave('./out/movie.mp4', images, fps=30)
